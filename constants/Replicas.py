...
ASK_TO_JOIN_GROUP = f'Не получилось отправить сообщение. {Emoji.SORRY_FACE}\n\nКажется, вы еще не вступили в группу или вышли из нее.\n\n{Emoji.ADVICE} Приглашение в группу может выдать админинстратор чата.'
...
CONSULTANT_ANSWER = '<i>отвечает </i> <b>{consultant}</b>:\n'
...
LINK_TO_TOPIC = "Ссылка на чат: <a href='{0}'> Диалог </a>"
...
# -invite links
JOIN_NOT_FROM_LINK = f"{Emoji.WARNING}В добавлении пользователя отказано.\nПожалуйста, добавьте пользователя через команду\n/invite [ИМЯ КОНCУЛЬТАНТА]\n{Emoji.ADVICE} Укажите настоящее имя, которое будут видеть покупатели"
JOIN_NOT_FROM_MY_LINK = f"{Emoji.WARNING}В добавлении пользователя отказано.\nПожалуйста, используйте ссылку которая была сгенерирована с помощью комманды\n/invite [ИМЯ КОНCУЛЬТАНТА]\n{Emoji.ADVICE} Укажите настоящее имя, которое будут видеть покупатели"
NOT_FULL_INVITE_COMMAND = f"{Emoji.STOP}Неправильный ввод команды, пожалуйста, убедитесь что написали через пробел имя консультанта"
GENERATE_LINK = "Ура! Новый консультант" + Emoji.CELEBRATION + "\nОтправте ему ссылки:\n1.<a href = '{0}'>ссылка-приглашение в группу</a>\n2.<a href ='{1}'>ссылка-приглашение в канал</a>"
# -watcher reflection
START_OF_REFLECTION = f"Минутку, админинстратор свяжется с вами. {Emoji.PENCIL}"
END_OF_REFLECTION_CLIENT_SIDE = f"Админинстратор закрыл диалог {Emoji.STAR}\nСпасибо за вашу связь админинстраторам {Emoji.WINKY_FACE}"
END_OF_REFLRECTION_CONSULTANT_SIDE = f"Админстратор закрыл диалог"
FROM_ADMIN_MESSAGE = f"<i>Сообщение от админинстраторов АвтоЛидер</i> {Emoji.CAR}\n"
