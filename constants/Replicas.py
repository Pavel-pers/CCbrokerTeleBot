...
ASK_NAME_POINT = 'Какое название будет у точки{0}(оно будет высвечиваться при выборе клинтом места, куда будет отправлен его вопрос{1})'.format(
...
# watchers
# -leaderboard
CONSULTANT_LEADERBOARD = 'Лидеры {0}:'.format(Emoji.CHAMPION)
